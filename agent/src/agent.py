...
class KubeVoiceAssistant(Agent):
    ...
    async def get_cluster_status(self, context: RunContext, namespace: Optional[str] = None) -> str:
        ...
        try:
            ...
            return ("I could not reach the Kubernetes API to check cluster status. "
                    "My service account may lack permissions, or the API server is unreachable.")
    ...
    async def get_namespace_events(self, context: RunContext, namespace: str) -> str:
        ...
        try:
            ...
            return (f"I could not fetch events for namespace {namespace}. "
                    "The namespace may not exist, or the API call failed.")
